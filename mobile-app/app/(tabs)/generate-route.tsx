...
export const ALL_CITIES = [
  ...
  { id: "Buzet", name: "Buzet" },
  { id: "Buje", name: "Buje" },
  { id: "Vodnjan", name: "Vodnjan" },
  { id: "Pazin", name: "Pazin" },
  { id: "Bale", name: "Bale" },
  { id: "Barban", name: "Barban" },
  { id: "Brtonigla", name: "Brtonigla" },
  { id: "Cerovlje", name: "Cerovlje" },
  { id: "Fažana", name: "Fažana" },
  { id: "Funtana", name: "Funtana" },
  { id: "Gračišće", name: "Gračišće" },
  { id: "Grožnjan", name: "Grožnjan" },
  { id: "Kanfanar", name: "Kanfanar" },
  { id: "Karojba", name: "Karojba" },
  { id: "Kaštelir-Labinci", name: "Kaštelir-Labinci" },
  { id: "Kršan", name: "Kršan" },
  { id: "Lanišće", name: "Lanišće" },
  { id: "Ližnjan", name: "Ližnjan" },
  { id: "Lupoglav", name: "Lupoglav" },
  { id: "Marčana", name: "Marčana" },
  { id: "Medulin", name: "Medulin" },
  { id: "Motovun", name: "Motovun" },
  { id: "Oprtalj", name: "Oprtalj" },
  { id: "Pićan", name: "Pićan" },
  { id: "Raša", name: "Raša" },
  { id: "Sveta Nedelja", name: "Sveta Nedelja" },
  { id: "Sveti Lovreč", name: "Sveti Lovreč" },
  { id: "Sveti Petar u Šumi", name: "Sveti Petar u Šumi" },
  { id: "Svetvinčenat", name: "Svetvinčenat" },
  { id: "Tar-Vabriga", name: "Tar-Vabriga" },
  { id: "Tinjan", name: "Tinjan" },
  { id: "Višnjan", name: "Višnjan" },
  { id: "Vižinada", name: "Vižinada" },
  { id: "Vrsar", name: "Vrsar" },
  { id: "Žminj", name: "Žminj" },
];
